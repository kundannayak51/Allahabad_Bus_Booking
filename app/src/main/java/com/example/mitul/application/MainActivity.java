...
public class MainActivity extends AppCompatActivity
    ...
    private void addMarkers() {
        ...
        LatLng station1 = new LatLng(25.442286,81.867551);
        mGoogleMap.addMarker(new MarkerOptions().position(station1).title("Sangam"));

        LatLng station2 = new LatLng(25.460244,81.859494);
        mGoogleMap.addMarker(new MarkerOptions().position(station2).title("Anand Bhawan"));

        LatLng station3 = new LatLng(25.458258,81.852327);
        mGoogleMap.addMarker(new MarkerOptions().position(station3).title("Chandrashekhar Azad Park"));

        LatLng station4 = new LatLng(25.471255,81.855744);
        mGoogleMap.addMarker(new MarkerOptions().position(station4).title("Katra"));

        LatLng station5 = new LatLng(25.433111,81.821628);
        mGoogleMap.addMarker(new MarkerOptions().position(station5).title("Allahabad High Court"));

        LatLng station6 = new LatLng(25.494274,81.861022);
        mGoogleMap.addMarker(new MarkerOptions().position(station6).title("Teliyarganj"));

        LatLng station7 = new LatLng(25.526179,81.855314);
        mGoogleMap.addMarker(new MarkerOptions().position(station7).title("Phaphamau"));

        LatLng station8 = new LatLng(25.444111,81.825787);
        mGoogleMap.addMarker(new MarkerOptions().position(station8).title("Prayagraj Junction"));

        LatLng station9 = new LatLng(25.459771,81.837535);
        mGoogleMap.addMarker(new MarkerOptions().position(station9).title("Civil Lines"));

        LatLng station10 = new LatLng(25.430083,81.744682);
        mGoogleMap.addMarker(new MarkerOptions().position(station10).title("Airport"));

        LatLng station11 = new LatLng(25.413709,81.855246);
        mGoogleMap.addMarker(new MarkerOptions().position(station3).title("Naini"));

        LatLng station12 = new LatLng(25.447652,81.840217);
        mGoogleMap.addMarker(new MarkerOptions().position(station3).title("Bus Station"));
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        LatLng allahabad = new LatLng(25.4394,81.8771);
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(allahabad, 10);
        mGoogleMap.moveCamera(cameraUpdate);
