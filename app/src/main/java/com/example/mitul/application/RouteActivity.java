...
public class RouteActivity extends AppCompatActivity
    ...
    private void drawline(String origin, String destination) {
        ...
        Call<GoogleDirectionResponse> call = myClient.getDirections(origin, destination, "Enter Key");
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(allahabad, 12);
        mGoogleMap.moveCamera(cameraUpdate);
    }
