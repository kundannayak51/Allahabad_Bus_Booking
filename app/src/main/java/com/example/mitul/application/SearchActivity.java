...
public class SearchActivity extends AppCompatActivity {
    ...
    String[] station ={"Bus Station","Sangam","Anand Bhawan","Chandrashekhar Azad Park","Katra","Allahabad High Court","Teliyarganj","Phaphamau",
    "Prayagraj Junction","Civil Lines","Airport","Naini"};
